                                ...
                                <tbody>
                                    @foreach ($quota as $quotas)
                                        <tr style="border-top: 1px solid #E0E0E0; border-collapse: separate;">
                                            ...
                                            <td>{{ $quotas->name }}</td>
                                            <td>
                                                <form action="quotas/{{ $quotas->id }}/edit" style="margin-top: 10px; margin-left: calc(100% - 70px);">
                                            ...
                                            <td>                
                                                <form action="quotas/{{ $quotas->id }}/confirmDestroy" style="margin-top: 10px; margin-left: calc(10% - 35px);">
...
<form action="{{url('quotas/create')}}" style="margin-left: 100px; margin-bottom: -20px;">
