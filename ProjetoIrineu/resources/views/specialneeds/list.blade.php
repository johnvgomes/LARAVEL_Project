                        ...
                        <tbody>
                            @foreach ($spneeds as $spneed)
                                <tr style="border-top: 1px solid #E0E0E0; border-collapse: separate;">
                                    ...
                                    <td>
                                        <form action="specialneeds/{{ $spneed->id }}/edit" style="margin-top: 10px; margin-left: calc(100% - 70px);">
                                    ...
                                    <td>                
                                        <form action="specialneeds/{{ $spneed->id }}/confirmDestroy" style="margin-top: 10px; margin-left: calc(10% - 35px);">
